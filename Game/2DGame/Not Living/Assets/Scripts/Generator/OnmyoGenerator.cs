...
public class OnmyoGenerator : MonoBehaviour
{
    //Chaisor's Prefab
    ...
    void CountMethod()
    {
        ...
        if (time % popinterval == 0 && day + grm.evilper / 25 > poplim)////悪行値の割合と日付で出現率を変える。初日＋何もしていない(悪行値50)のばあい2人まで出る
