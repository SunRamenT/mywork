...
public class ShinigamiGenerator : MonoBehaviour
{
    //NPC's Prefab
    ...
    private void Pop()
    {
        ...
        poplist.Add(newNPC);
        // NPC座標決め
        var pos = new Vector3(playpos.x + Random.Range(-xlim, xlim), playpos.y + Random.Range(-ylim, ylim), 0f);
        //範囲制限
