...
set output "'${graph}'-ml-reach-hitting.eps"
...
set ylabel "reachability" font "Helvetica,20
...
' > ${graph}-attack-reach-hitting.res
...
echo $1 $agent_1 $agent_1_conf  $agent_2 $agent_2_conf  $agent_3 $agent_3_conf $agent_4 $agent_4_conf $agent_5 $agent_5_conf $agent_6 $agent_6_conf  $agent_7 $agent_7_conf $agent_8 $agent_8_conf >> ${graph}-attack-reach-hitting.res
echo 'EOD' >> ${graph}-attack-reach-hitting.res
...
plot $DATA using ($0):2:3 with boxerrorbars notitle  linecolor rgb gray, \
     ...
     $DATA using ($0+1.40):16:17 with boxerrorbars notitle  linecolor rgb green3' >> ${graph}-attack-reach-hitting.res


gnuplot ${graph}-attack-reach-hitting.res
