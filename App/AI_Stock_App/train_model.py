...
# --- このスクリプトは、モデルを学習させ、ファイルに保存するためだけに一度だけ実行します ---

# CONFIGなどの設定はapp.pyからコピー
warnings.filterwarnings('ignore')
CONFIG = {
    "start_date": "2021-08-01",
    "end_date": "2025-08-01", # バックテストと学習のために未来の日付を使う
...
if __name__ == '__main__':
    ...
    # モデルをファイルに保存
    joblib.dump(final_model, 'model.lgb')
    print("\n--- モデルを'model.lgb'として保存完了 ---")
